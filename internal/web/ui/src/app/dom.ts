...
export function getElements() {
  return {
    ...
    statToday: requireElement('statToday', HTMLElement),
    statLast: requireElement('statLast', HTMLElement),
    overviewEndpoints: requireElement('overviewEndpoints', HTMLElement),
    overviewRequests: requireElement('overviewRequests', HTMLElement),
    requestsSection: requireElement('requestsSection', HTMLDivElement),
    settingsSection: requireElement('settingsSection', HTMLDivElement),
    webhookSettings: requireElement('webhookSettings', HTMLDivElement),
    sectionTabs: Array.from(
      document.querySelectorAll<HTMLButtonElement>('.section-tab[data-section]'),
    ),
